ServerEvents.recipes(event =>{//常规化学反应（被特殊催化）
    ...
    .inputFluids(Fluid.of('gtceu:oxygen',1440))
    .inputFluids(Fluid.of('gtceu:nitrogen',1440))
    .outputFluids(Fluid.of('gtceu:aqua_regia',5760))
    .duration(100)
    .EUt(64)//格雷科技王水定向制作Ⅰ
    ...
    .inputFluids(Fluid.of('gtceu:nitrogen',14400))
    .outputFluids(Fluid.of('gtceu:aqua_regia',57600))
    .duration(100)
    .EUt(64)//格雷科技王水定向大批量制作Ⅰ
